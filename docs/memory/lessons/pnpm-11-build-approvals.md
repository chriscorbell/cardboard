...
Scope: workspace
Verified: 2026-09-15
Source: the full acceptance command passed again on mbp for Card mq729n on 2026-09-15 UTC; observed in this workspace on 2026-09-13 with pnpm 11.25.0; re-checked 2026-09-14 in a Session container, where `pnpm install --frozen-lockfile` ran the esbuild and `@clerk/shared` postinstalls with the correction below in place; check `pnpm-workspace.yaml`
