...
2026-09-13: ordinary review after the design interview. Sampled `context/minicore-deployment-constraints.md` (written this session, checked against the fleet survey). `lessons/` and `work/` were empty. Next cursor: `context/` entry 1.
