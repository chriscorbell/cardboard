...
4. Implement on branch ${input.card.branch ?? "(assigned by Cardboard)"} with tests. Never push to the default branch.
5. Open or update the pull request and make a preview available (${input.board.previewMode} preview mode).
